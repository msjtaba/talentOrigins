...
import { useEffect, useRef, memo, useState, useId } from 'react';
...
const DotField = memo(({
  ...
  sparkle = false,
  waveAmplitude = 0,
  gradientFrom = 'rgba(6, 113, 75, 0.35)',
  gradientTo = 'rgba(46, 156, 114, 0.20)',
  glowColor = '#0A0F0D',
  ...rest
}: DotFieldProps) => {
  ...
  useEffect(() => {
    ...
    const skipAnimation = isMobile || prefersReducedMotion;
